...
export const LoginForm = () => {
  ...
  const onLogin = useCallback (async () => {
    ...
    try {
      ...
      setEmail({ ...email, error: true, errorMessage: 'Email ou senha inválidos' });
      setPassword({ ...password, error: true, errorMessage: 'Email ou senha inválidos' });
    }
  }, [email, password]);
      ...
      <S.LoginFormBackground>
          <S.LoginFormContainer>
            ...
            <S.LoginFormContent>
              ...
              <S.LoginFormInput placeholder='Email' label="E-mail" type='email' onChange={onEmailChange} {...email} />
              <S.LoginFormLabel>Senha</S.LoginFormLabel>
              <S.LoginFormInput placeholder='Senha' label="Senha" type='password' onChange={onPasswordChange} {...password} onBlur={onPasswordBlur} />
